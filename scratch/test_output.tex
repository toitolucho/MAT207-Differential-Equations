...
a) Ecuaciones Diferenciales Ordinarias → \colorbox[RGB]{248,231,28}{no hay fraciones parciales}
...
b) Ecuaciones Diferenciales No Ordinarias→ Estan presentes las derivadas Parciales


\begin{gather*}
\frac{∂^{2}u}{∂x^{2}}+\frac{∂^{2}u}{∂y^{2}} = 0       \frac{∂^{2}u}{∂x^{2}}= \frac{∂^{2}u}{∂t^{2}} -2

\end{gather*}


\textbf{Grado de Una Ecuacion Diferencial} → Asociado al \colorbox[RGB]{248,231,28}{Exponente Mayor} presente dentro de la E.D. que representa el orden de la E.D.


\begin{gather*}
(\frac{d^{2}y}{dx^{2}})^{3} + (\frac{dy}{dx})^{2}  - 5y = 0           \frac{d^{3}y}{dx^{3}} + (\frac{dy}{dx})^{3} +3x\colorbox[RGB]{248,231,28}{$($}\colorbox[RGB]{248,231,28}{$\frac{d^{3}y}{dx^{3}}$}\colorbox[RGB]{248,231,28}{$)$}\colorbox[RGB]{248,231,28}{$^{2}$}- 5y = 0  \\
\text{E.D. de Grado 3                           E.D. de Grado 2                       }

\end{gather*}


\textbf{Orden de una E.D.} → Representa la mayor derivada presente dentro de la E.D.


\begin{gather*}
\colorbox[RGB]{248,231,28}{$\frac{d^{4}y}{dx^{4}}$}+5y=x                     \frac{dy}{dx}+ \colorbox[RGB]{248,231,28}{$\frac{d^{3}y}{dx^{3}}$} - 5y = 0  \\
